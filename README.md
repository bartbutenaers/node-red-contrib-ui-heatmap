...
+ @cmayor314 [created](https://github.com/bartbutenaers/node-red-contrib-ui-heatmap/pull/10) a frequency spectrogram (75 harmonics and 150 time samples) - based on the [fft-js](https://www.npmjs.com/package/fft-js) Fast Fourier Transform (FFT) nodejs library - using water depth time samples as the source of the FFT frequencies.   He was able to visualize this using this node:
